...
namespace AgOpenGPS
{
    public partial class FormConfig
    {
        ...
        private void tabDHeading_Enter(object sender, EventArgs e)
        {
            ...
            slowFilterChk.Checked = Properties.Settings.Default.isSlowFilter;
        ...
        private void tabDHeading_Leave(object sender, EventArgs e)
        {
            ...
            Properties.Settings.Default.isSlowFilter = slowFilterChk.Checked;
            Properties.Settings.Default.setF_minFixStep = (double)nudMinFixStepDistance.Value;
            mf.minFixStepDist = (double)nudMinFixStepDistance.Value;
