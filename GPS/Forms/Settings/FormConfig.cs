...
namespace AgOpenGPS
{
    public partial class FormConfig : Form
    {
        ...
        private void slowFilterChk_CheckedChanged(object sender, EventArgs e)
        {
            mf.isSlowFilter = slowFilterChk.Checked;
            Properties.Settings.Default.isSlowFilter = mf.isSlowFilter;
