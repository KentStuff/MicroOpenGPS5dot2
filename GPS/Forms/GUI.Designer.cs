...
namespace AgOpenGPS
{
    public partial class FormGPS
    {
        ...
        public bool isSlowFilter = false;
        ...
        {            //metric settings
            ...
            isSlowFilter = Properties.Settings.Default.isSlowFilter;
        ...
        private void ZoomByMouseWheel(object sender, MouseEventArgs e)
        {
            ...
            else
            {
                ...
                { if ((camera.zoomValue -= camera.zoomValue * 0.06) < 3.0) camera.zoomValue = 3.0; }
                else { if ((camera.zoomValue -= camera.zoomValue * 0.02) < 3.0) camera.zoomValue = 3.0; }
        ...
        private void oglMain_MouseDown(object sender, MouseEventArgs e)
        {
            if (e.Button == MouseButtons.Left)
            {
                ...
                if (point.X > oglMain.Width - 80)
                {
                    ...
                    {
                        if (camera.zoomValue <= 20)
                        { if ((camera.zoomValue -= camera.zoomValue * 0.2) < 3.0) camera.zoomValue = 3.0; }
                        else { if ((camera.zoomValue -= camera.zoomValue * 0.1) < 3.0) camera.zoomValue = 3.0; }
